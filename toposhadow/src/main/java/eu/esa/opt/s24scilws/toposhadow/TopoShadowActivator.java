package eu.esa.opt.s24scilws.toposhadow;
...
public class TopoShadowActivator implements Activator {
    ...
    public void start() {
        ...
        Path auxdataDirectory = SystemUtils.getAuxDataPath().resolve("opttbx/s24scilws/toposhadow");;
    ...
    public static Path getAuxDataDir() {
        return SystemUtils.getAuxDataPath().resolve("opttbx/s24scilws/toposhadow");
    }
}