package eu.esa.opt.s24scilws.lacs2;
...
public class LACActivator implements Activator {
    ...
    public void start() {
        ...
        Path auxdataDirectory = SystemUtils.getAuxDataPath().resolve("opt/s24scilws/lacs2");
    ...
    public static Path getAuxDataDir() {
        return SystemUtils.getAuxDataPath().resolve("opt/s24scilws/lacs2");
    }
}